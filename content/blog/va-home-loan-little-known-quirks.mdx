...
In these cases, we would need a detailed explanation letter, documentation to support, and would need to count any housing and commuting expenses.  These expenses could include flight or driving costs, rent for the temporary home, and there are even costs to include when living rent free.  Every situation is different, so ask us about your scenario.  **[Learn more](/blog/va-home-loan-occupancy-requirements/)**
...
-   **[Determining if a primary residence is within a reasonable commute to work](/blog/va-home-loan-occupancy-requirements/)**
